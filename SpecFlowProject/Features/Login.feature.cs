...
#line hidden
        ...
        public virtual void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "Features", "Login Successful", "As a consumer of the API, when I submit valid credentials the API should return v" +
                    "alid token.", ProgrammingLanguage.CSharp, ((string[])(null)));
        ...
        public virtual void LoginWithValidCredo()
        {
            string[] tagsOfScenario = ((string[])(null));
            System.Collections.Specialized.OrderedDictionary argumentsOfScenario = new System.Collections.Specialized.OrderedDictionary();
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Login with valid credo", null, tagsOfScenario, argumentsOfScenario, this._featureTags);
#line 5
